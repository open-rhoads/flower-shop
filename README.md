...
Next, I need to add a View Cart button and buttons to Add to Cart on the Products page, put the Add to Cart buttons on the Product list page too, and add the Checkout functionality.
